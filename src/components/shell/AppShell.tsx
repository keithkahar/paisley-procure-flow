      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <header className="sticky top-0 z-30 flex h-[var(--topbar-h)] items-center gap-4 border-b border-border bg-surface/85 px-[var(--topbar-px)] backdrop-blur">
          <div className="flex min-w-0 items-end gap-3">
            ...
            <span className="hidden -translate-y-[7.5px] scale-[0.622] origin-bottom-left text-[28px] font-[160] leading-none tracking-tight text-foreground/90 md:block whitespace-nowrap">
